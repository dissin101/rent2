            ...
            <div className="col-md-6">
                <div className="card">
                    <header className="card-header">
                        <Link to="/login" className="float-right btn btn-outline-primary mt-1">Авторизация</Link>
                    ...
                    <div className="border-top card-body text-center">У вас уже есть аккаунт? 
